...
(function($) {
	...
	_init: function() {
		...
		let msg = {
		    ...
		    marks: {
			answerplease: $("input[value=answerplease]:checked", self.element).length ? "answerplease": "answered",
			subscribe: $("input[value=unclear]:checked", self.element).length ? "subscribe": "unsubscribe"
		    }
		};
		let component_name;
