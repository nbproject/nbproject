...
(function($) {
    ...
    var V_OBJ = $.extend({},$.ui.view.prototype,{
		...
		//let controls = $("<div class='panel controls'><img src='/data/icons/png/proto/thumbnail_controls.png' style='max-width: 180px'/></div>");
		...
		//	thumbnails.height(self.element.height() - controls.height());
		//		$("#"+VIEWID+">div.fileLister-ensemble > div.ensemble").live("click", _click_ensemble);
		$("#"+VIEWID+">ol.thumbnails > li.thumbnail > div.thumbnail-contents").live("click", _click_page);
	    },
		...
		switch (evt.type){
		    ...
		    $("div.thumbnail-contents[id_item="+evt.value+"]", self.element).addClass("selected");
		...
		//	thumbnails.height(this.element.height() - controls.height());
	    },
	    _update: function(){
