...
(function($) {
    ...
    var V_OBJ = $.extend({},$.ui.view.prototype,{
        ...
        _defaultHandler: function(evt){
            ...
            if (self._id_source === $.concierge.get_state("file")){
                ...
                case "filter_emoticons":
                    ...
                    // var locs_emoticon = locs.intersect(emoticon_id_locs);
        ...
        _update_filters: function(){
            ...
            // var n_emoticon = locs_emoticon.length();
            ...
            // $("div.filter-count", $filter_emoticon).text(n_emoticon);
            if (filters_on){
        ...
        _recalculate_locs: function() {
            ...
            // locs_emoticon = locs.intersect(emoticon_id_locs);

            if (self._filters.emoticon){
                // self.locs = self.locs.intersect(emoticon_id_locs);
