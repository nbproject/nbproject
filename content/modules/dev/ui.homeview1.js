...
(function($) {
    ...
    var V_OBJ = $.extend({},$.ui.view.prototype,{
        ...
        var splashtext="<div style='padding: 30px; font-size: x-large; color: #a0a0a0;'>Future Homeview page</div>";
        var header    = self._admin ? "<div class='homeView-header'><button action='add_file'>Add file</button> <button action='add_folder'>New folder</button> <button action='invite_users'>Invite Users</button> <a id='see_users' target='_blank'>Users</a> <a id='group_sections' target='_blank'>Sections</a> <a id='group_props' target='_blank'>Properties</a>  <a id='spreadsheet' target='_blank'>Spreadsheet</a></div>" : "";
        var opts    = self._admin ? "<th>Actions</th>" : "";
        self.element.addClass("homeView").html("<div id='filesview-splash'>"+splashtext+"</div>"+header+"<div class='homeView-ensemble'/><div class='homeView-files'> <table class='tablesorter'><thead><tr><th>Name</th><th>Assignment</th><th id='th_download'>Download PDF</th><th>Stats</th>"+opts+"</tr></thead><tbody/></table></div>");
        ...
        return $("<tr class='filesview_row' id_item='"+f.ID+"'><td class='filesview_ftitle'><div class='nbicon "+type_class+"'/><a class='aftericon' target='_blank' href='/f/"+f.ID+"'>"+$.E(f.title)+"</a></td><td>"+assignment_info+"</td>"+download+stats+opts+"</tr>");
        ...
        /*
        $e_info = $("div.homeView-ensemble").empty();
    ...
    $.widget("ui.homeView",V_OBJ );
    $.ui.homeView.prototype.options = {
