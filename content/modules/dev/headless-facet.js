...
Exhibit.HeadlessFacet.prototype.clearAllRestrictions = function() {
...
Exhibit.HeadlessFacet.prototype.applyRestrictions = function(restrictions) {
    this._valueSet = new Exhibit.Set();
...
Exhibit.HeadlessFacet.prototype._filter = function(value, label, selectOnly) {
    var self = this;
    var selected, select;
    ...
    self.applyRestrictions({ selection: newValues.toArray(), selectMissing: newSelectMissing });
