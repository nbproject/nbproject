        ...
        */
        ...
        set_tablesort: function(){
            $("table.tablesorter").tablesorter({
                ...
                sortList: [[2,0]], // default sorting by [col index, asc/desc] where the cols are [date added, last seen, alphabetical]. use 0 for asc, 1 for desc
