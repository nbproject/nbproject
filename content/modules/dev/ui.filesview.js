...
(function($) {
    var V_OBJ = $.extend({},$.ui.view.prototype,{
		...
		$("body").append("<ul id='contextmenu_filesview' class='contextMenu'><li class='rename'><a href='#rename'>Rename</a></li><li class='move'><a href='#move'>Move</a></li><li class='update'><a href='#update'>Update</a></li><li class='delete separator'><a href='#delete'>Delete</a></li></ul>");
		
	    },
	    _defaultHandler: function(evt){
		switch (evt.type){
		case "folder": 
		this._setData("id_ensemble",  this._getData("model").o.folder[evt.value].id_ensemble);
		this._setData("id_folder", evt.value);
		//		this._render(this._getData("model").o.folder[evt.value].id_ensemble, evt.value);			    
		break;
		case "ensemble": 
		this._setData("id_ensemble", evt.value);
		this._setData("id_folder",  null);
		break;
		}		
		this._render();
	    },
	    _lens: function(f){
		return $("<tr class='filesview_row' id_item='"+f.ID+"'><td class='filesview_ftitle'><div class='nbicon pdficon'/><a class='aftericon' target='_blank' href='/?id_source="+f.ID+"'>"+$.E(f.title)+"</a></td><td><a target='_blank' href='"+this.options.img_server+"/pdf/repository/"+f.ID+"?invite_key="+this.options.invite_key+"'>original</a> <a target='_blank' href='"+this.options.img_server+"/pdf/annotated/"+f.ID+"?invite_key="+this.options.invite_key+"'>annotated</a></td><td><a href='javascript:void(0)' class='optionmenu'>Actions</a></td></tr>");
	    }, 	    
	    _render: function(){		
		var self=this;
		$("#filesview-splash").hide();
		var id_ensemble = self._getData("id_ensemble");
		var id_folder = self._getData("id_folder");
