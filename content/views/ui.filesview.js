...
define(['concierge','view','jquery','contextmenu','tablesorter','calendrical','moment'],
  ...
  var V_OBJ = $.extend({}, $.ui.view.prototype, {
    ...
    _filelens: function (f) {
      ...
      var assignment_info = f.assignment ? ('Yes - due ' + moment(f.due).format("YYYY-MM-DD [at] HH:mm a"))  : 'No';
      var download = '';
      ...
      // TODO: 4 and 2 should not be hardcoded
      if (f.filetype === 4) { type_class = 'html5icon'; }

      if (f.filetype === 2) { type_class = 'youtubeicon'; }
