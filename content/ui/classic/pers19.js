...
$(document).ready(function(){
	...
	NB.pers.call("getObjects",{types: ["ensembles", "folders", "files", "assignments", "marks", "settings"]},NB.pers.on_getStore);
...
NB.pers.addFile = function(id_ensemble){
    $('#add_file_dialog').dialog({
	    title: "Add a File in '"+NB.pers.store.o.ensemble[id_ensemble].name+"'...", 
	    width: 390, 
	    buttons: { 
		"Cancel": function() { 
		    $(this).dialog("close");  
		...
		"Ok": function() {
		    ...
		    NB.pers.call("request_source_id", {}, NB.pers.proceedUpload);
