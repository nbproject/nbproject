...
$(document).ready(function(){
	...
	NB.pers.call("getObjects",{types: ["ensembles", "folders", "files", "marks", "settings", "file_stats", "ensemble_stats", "ensemble_stats2"]},NB.pers.on_getStore);
...
NB.pers.on_getStore = function(payload){
    ...
    */
	...
	return "<tr id_item='"+j+"'><td>"+E[j].name+"</td><td><a href='?t=p24&amp;view=newauth&amp;id_ensemble="+j+"'>"+S2[j].newauth+"</a> <span class='caption'> unseen replies related to my </span> <a href='?t=p24&amp;view=auth&amp;id_ensemble="+j+"'>"+S2[j].auth+"</a> <span class='caption'>comments</span></td><td>"+a+"</td></tr>";
    }
