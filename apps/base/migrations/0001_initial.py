    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=255)),
                ('ensemble', models.ForeignKey(to='base.Ensemble', on_delete=models.CASCADE)),
                ('parent', models.ForeignKey(to='base.Folder', null=True, on_delete=models.SET_NULL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(to='base.LabelCategory', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ensemble', models.ForeignKey(to='base.Ensemble', on_delete=models.CASCADE)),
                ('folder', models.ForeignKey(to='base.Folder', null=True, on_delete=models.SET_NULL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('setting', models.ForeignKey(to='base.DefaultSetting', on_delete=models.CASCADE)),
                ('value', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctime', models.DateTimeField(default=datetime.datetime.now, db_index=True)),
                ('comment', models.ForeignKey(to='base.Comment', null=True, on_delete=models.SET_NULL)),
                ('location', models.ForeignKey(to='base.Location', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.OneToOneField(to='base.Source', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(to='base.User', on_delete=models.CASCADE),
        ...
        migrations.AddField(
            ...
            name='submittedby',
            field=models.ForeignKey(blank=True, to='base.User', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='source',
        ...
        migrations.AddField(
            ...
            name='threadmark',
            field=models.ForeignKey(to='base.ThreadMark', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='processqueue',
            name='source',
            field=models.ForeignKey(to='base.Source', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='pageseen',
            name='session',
            field=models.ForeignKey(to='base.Session', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='pageseen',
            name='source',
            field=models.ForeignKey(to='base.Source', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='pageseen',
            name='user',
            field=models.ForeignKey(to='base.User', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='source',
            field=models.OneToOneField(to='base.Source', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='membership',
            name='section',
            field=models.ForeignKey(to='base.Section', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='membership',
        ...
        migrations.AddField(
            model_name='idle',
            name='session',
            field=models.ForeignKey(to='base.Session', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='html5location',
            name='location',
            field=models.OneToOneField(to='base.Location', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='guest',
            field=models.ForeignKey(related_name='u1', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='guestloginhistory',
            name='user',
            field=models.ForeignKey(related_name='u2', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(to='base.LabelCategory', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='commentlabelhistory',
            name='comment',
            field=models.ForeignKey(to='base.Comment', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='commentlabelhistory',
        ...
        migrations.AddField(
            model_name='comment',
            name='location',
            field=models.ForeignKey(to='base.Location', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(to='base.Comment', null=True, on_delete=models.SET_NULL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignmentgradehistory',
            name='grader',
            field=models.ForeignKey(related_name='g_grade_h', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignmentgradehistory',
        ...
        migrations.AddField(
            model_name='assignmentgradehistory',
            name='user',
            field=models.ForeignKey(related_name='u_grade_h', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignmentgrade',
            name='grader',
            field=models.ForeignKey(related_name='g_grade', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='assignmentgrade',
        ...
        migrations.AddField(
            model_name='assignmentgrade',
            name='user',
            field=models.ForeignKey(related_name='u_grade', to='base.User', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
